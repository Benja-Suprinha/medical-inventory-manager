...
CREATE TABLE IF NOT EXISTS "users"(ID SERIAL PRIMARY KEY, ID_admin INT, type_user VARCHAR(255), username VARCHAR(255), "password" VARCHAR(255), "name" VARCHAR(255), mail VARCHAR(255), telefono VARCHAR(255));
...
INSERT INTO "users" (ID_admin, type_user, username, "password", "name" , mail, telefono) VALUES (1, 'admin', 'admin1', 'pass123','hector salamanca', 'hectors@mail.udp.cl', '+56 945756941');
INSERT INTO "users" (ID_admin, type_user, username, "password", "name" , mail, telefono) VALUES (1, 'encargado_inventario', 'usuario1', 'pass123', 'walter white', 'wh1@mail.udp.cl', '+56 945756942');
INSERT INTO "users" (ID_admin, type_user, username, "password", "name" , mail, telefono) VALUES (1, 'personal_medico', 'usuario2', 'pass', 'ana vasquez', 'anav@mail.udp.cl', '+56 945756943');
